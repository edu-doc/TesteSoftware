...
public class CadastroJornadaFalhaTest {
    ...
    void testFluxoDeCadastroComSucesso() {
        ...
        // Primeiro, espera um elemento da tela de cadastro aparecer para garantir que a navegação ocorreu.
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("foto")));

        // Preenche e submete o formulário de cadastro.
        cadastroPage.realizarCadastro(driver, "admin", "admin", "https://github.com/BenAriel/teste-software-front/blob/master/public/benno.jpg?raw=true");

        // Agora, o teste espera que uma mensagem de erro seja exibida, pois o usuário já existe.
